...
var FrDateComponent = (function () {
    ...
    FrDateComponent.prototype.closeDateDialog = function () {
        this.frDateService.emit('date:dialog:close');
    };
    /**
     * @return {?}
     */
